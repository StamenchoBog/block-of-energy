...
export async function submitToLedger(id: string, hashValue: string, timestamp: string, deviceID: string): Promise<void> {
    ...
    try {
        ...
        console.log(`
--> Submit Transaction: CreateHash, ID: ${id}, Hash: ${hashValue}`);
